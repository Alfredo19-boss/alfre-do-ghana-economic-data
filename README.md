...
- **Global markets tab** (`#markets`): world share indices, commodities (gold, cocoa, oil, copper, coffee), crypto and the major currency pairs, each with the day's move and the moment it was quoted, refreshed every 20 minutes
- **World news tab** (`#world`): what the world's wires are carrying right now — Reuters, the Associated Press, the BBC, Al Jazeera, France 24 and CNBC — with the three newest given room at the top and a search box. Headlines and links only; every story opens on the publisher's own page
...
world-data.js              world and African headlines, every 5 minutes (do not edit)
